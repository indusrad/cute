...
static void
ptyxis_settings_add_proxy_environment (PtyxisSettings *self,
                                       const char     *protocol,
                                       const char     *envvar,
...
char **
ptyxis_settings_get_proxy_environment (PtyxisSettings *self)
{
  g_autoptr(GStrvBuilder) builder = NULL;
  g_autoptr(GSettings) settings = NULL;
  ...
  ptyxis_settings_add_proxy_environment (self, "http", "http_proxy", builder);
  ptyxis_settings_add_proxy_environment (self, "https", "https_proxy", builder);
  ptyxis_settings_add_proxy_environment (self, "ftp", "ftp_proxy", builder);
  ptyxis_settings_add_proxy_environment (self, "socks", "all_proxy", builder);
