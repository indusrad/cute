...
static const PromptPaletteData prompt_palettes_inline[] = {
  {
    .id = "gnome",
    .name = N_("GNOME"),
    .faces = {
...

  {
    ...
    .faces = {
      {
        .foreground = GDK_RGBA ("52676f"),
        .background = GDK_RGBA ("fcf4dc"),
        .indexed = {
          GDK_RGBA ("002731"),
          GDK_RGBA ("d01b24"),
          GDK_RGBA ("728905"),
      ...
      {
        .foreground = GDK_RGBA ("708183"),
        .background = GDK_RGBA ("001e26"),
        .indexed = {
          GDK_RGBA ("002731"),
          GDK_RGBA ("d01b24"),
          GDK_RGBA ("728905"),
