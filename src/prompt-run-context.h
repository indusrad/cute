...
void                 prompt_run_context_push_error              (PromptRunContext         *self,
                                                                 GError                   *error);
void                 prompt_run_context_push_host               (PromptRunContext         *self);
void                 prompt_run_context_push_shell              (PromptRunContext         *self,
                                                                 PromptRunContextShell     shell);
void                 prompt_run_context_push_expansion          (PromptRunContext         *self,
...
void                 prompt_run_context_set_cwd                 (PromptRunContext         *self,
                                                                 const char               *cwd);
void                 prompt_run_context_set_pty_fd              (PromptRunContext         *self,
                                                                 int                       consumer_fd);
void                 prompt_run_context_set_pty                 (PromptRunContext         *self,
                                                                 VtePty                   *pty);
